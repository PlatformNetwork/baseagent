...
from superagent.config.models import AgentConfig, OutputMode
from superagent.core.session import Session
from superagent.output.events import Event
from superagent.tools.base import ToolResult
...
class OutputProcessor:
    ...
    def _emit_human(self, event: Event) -> None:
        ...
        from superagent.output.events import EventType
